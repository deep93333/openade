...
export const InlineToolRow = ({
  ...
  const [open, setOpen] = useState(alwaysShowBody);
  const isExpandable = hasDetails && !alwaysShowBody;
  const showBody = alwaysShowBody || open;
        ...
        <AnimatePresence initial={false}>
          {showBody && children != null && (
            <motion.div
              ...
              initial={alwaysShowBody ? false : { opacity: 0, height: 0 }}
