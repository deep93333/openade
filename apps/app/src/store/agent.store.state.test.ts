...
function wsState(overrides: Partial<{
  ...
  threadRuntime: Record<string, { status: "idle" | "running" | "error" | "stopped"; error: string | null; streamingText: string; sessionId: string | null }>;
  ...
  return {
    ...
    threadRuntime: {
      [threadA]: { status: "idle" as const, error: null, streamingText: "", sessionId: null },
    },
    sessionToThread: {},
    ...overrides,
  };
      ...
      useAgentStore.setState({
        workspaces: {
          [workspaceId]: wsState({
            ...
            threadRuntime: {
              [threadA]: { status: "idle", error: null, streamingText: "", sessionId: null },
              [threadB]: { status: "idle", error: null, streamingText: "", sessionId: null },
            },
      ...
      useAgentStore.setState({
        workspaces: {
          [workspaceId]: wsState({
            ...
            activeThreadId: threadA,
            threadRuntime: {
              [threadA]: { status: "error", error: "err A", streamingText: "", sessionId: null },
              [threadB]: { status: "error", error: "err B", streamingText: "", sessionId: null },
            },
          }),
        },
      });
